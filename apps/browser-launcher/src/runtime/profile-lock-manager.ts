...
export class ProfileLockManager {
  ...
  constructor(options: { instanceId?: string; processId?: number; heartbeatIntervalMs?: number } = {}) {
  ...
  acquireDurableLock(profileId: string, userDataDir: string, browserSessionId: string): string {
